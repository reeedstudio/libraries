...
void setup()
{
  ...
  //  Tft.drawChar('D',40,120,4,YELLOW);          // draw char: 'D', (40, 120), size: 4, color: YELLOW
    ...
    Tft.drawString("Hello",0,180,4,CYAN);       // draw string: "hello", (0, 180), size: 3, color: CYAN
    
    Tft.drawString("World!!",60,220,3,WHITE);    // draw string: "world!!", (80, 230), size: 4, color: WHITE
